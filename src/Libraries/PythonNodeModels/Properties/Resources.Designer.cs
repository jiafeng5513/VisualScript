...
namespace PythonNodeModels.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   查找类似 Result of the python script 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Runs an embedded IronPython script. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Edit Python Script... 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 The inputs to this node will be stored as a list in the IN variables. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Assign your output to the OUT variable. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Runs a IronPython script from a string. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Python script to run. 的本地化字符串。
        /// </summary>
