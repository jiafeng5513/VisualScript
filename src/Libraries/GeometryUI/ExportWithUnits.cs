    ...
    public class ExportWithUnits : NodeModel
    {
        ...
        public ExportWithUnits()
        {
            ...
            InPorts.Add(new PortModel(PortType.Input, this,
                new PortData("geometry", Resources.ExportToSatGeometryInputDescription)));
            InPorts.Add(new PortModel(PortType.Input, this,
                new PortData("filePath", Resources.ExportToSatFilePathDescription, new StringNode())));
            OutPorts.Add(new PortModel(PortType.Output, this,
                new PortData("string", Resources.ExportToSatFilePathOutputDescription)));
            ...
            List<AssociativeNode> inputAstNodes)
        {
            ...
            var temp = AstFactory.BuildStringNode("x");
            ...
            node = AstFactory.BuildFunctionCall(
                new Func<string, string, string, string>(Conversions.FuncTestFuck),
                new List<AssociativeNode> { geometryListNode, filePathNode, temp });
        ...
        protected override void DeserializeCore(XmlElement element, SaveContext context)
        {
            ...
            SelectedExportedUnit = Enum.Parse(typeof(ConversionUnit), exportedUnit) is ConversionUnit
                ? (ConversionUnit) Enum.Parse(typeof(ConversionUnit), exportedUnit)
                : ConversionUnit.Feet;
        }
